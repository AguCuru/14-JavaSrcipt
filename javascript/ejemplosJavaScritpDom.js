...
console.log(parrafo);
console.log(
  "Mostramos el contenido del parrafo modificado con js -------> " +
    parrafo.innerHTML
); //solo el contenido
console.log(
  "Mostramos el contenido del parrafo modificado con js -------> " +
    parrafo.outerHTML
); //includia la etiqueta
...
inputNombre.addEventListener("change", (e) => {
  //evento para obtener el valor del input
...
const filtrar = () => {
  ...
  for (let producto of productos) {
    ...
    if (nombre.includes(texto)) {
      resultados.innerHTML += `<li>${producto.nombre} - $${producto.valor}</li>`;
    }
  }
