...
//array de objetos
let arrayDeObjetos = [
  { Nombre: "Juanma", Apellido: "Diez" },

  { Nombre: "Santi", Apellido: "Alzamora" },
...
const arrayEnMayuscula = array.map((element) => {
  //Creamos un nuevo arreglo modificado segun nuestras necesidades
